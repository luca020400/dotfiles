...
export PATH="$HOME/bin:$HOME/.gem/ruby/2.3.0/bin/:/usr/lib/ccache/bin:$PATH"
...
alias nano='mcedit'
alias mka='LC_ALL=C mka'
alias venv='. $HOME/android/venv/bin/activate'
alias pacman='sudo pacman'
alias wget='wget -c'
alias scrot='scrot -c -d 7'
alias repopick='repopick -g ssh://luca020400@review.cyanogenmod.org:29418'
